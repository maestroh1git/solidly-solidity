...
contract Game {
    ...
    function pickACard() private view returns(uint){
         ...
         * which is further converteed to a `uint`.
         * Keccak256 is a hashing function which takes in a bytes array anf converts it into a bytes32
         */
     ...
     * If the player guessed the correct number, it sends the pl;ayer `0.1 ether`
     */
